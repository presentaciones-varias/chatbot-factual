...
format:
  revealjs:
    ...
    scrollable: true
    preview-links: auto
    logo: imagenes/logo_portada3.png
    css: ine_quarto_style_v2025.css
    # footer: <https://quarto.org>
---

# {.portada #portada}

<img src="imagenes/logo_portada3.png" width="18%" style="margin-top:10%"/>  

[**Título**]{.big-par .center-justified style="font-size:4rem;"} 

[**Bajada Conceptual del Contenido de la Presentación**]{.big-par .center-justified style="font-size:2.4rem;"} 
[**INSTITUTO NACIONAL DE ESTADÍSTICAS**]{.big-par .center-justified style="font-size:1.4rem;margin-top:2vh"} 

[**Fecha**]{.big-par .center-justified style="font-size:1.7rem;"}
